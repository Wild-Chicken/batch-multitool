rem The Change Log!!
rem Added:
rem 	another secrect! we now have 11! great!!
rem 	added 7 lines to the clean files, now you can free even MOAR SPACE!!11!
rem Removed:
rem 	nothing
rem Improved:
rem 	now its cleanmgr /sagerun instead of cleanmgr /sagerun:1 (in clean files)
...
if "%wow%"=="1" (
    ...
    del /f /q "%temp%\*"
	del /f /q "C:\ProgramData\Package Cache\*"
