rem The Change Log!!
rem Added:
rem 	timeout for 1s after doing manual cleanup for a chance to see what happened before the screen cleared
rem		added "end of script" note at the end of the script
rem 	added extra line at the end of the script
rem Removed:
rem 	nothing
rem Improved:
rem 	better "error handling" for cleaning files
rem 	renamed "go to my repo page" to "go to my user-friendly repo selector for lazy humans"
