@echo off
:: Update v3.22.4
:: Secrect Count: 14 (miscounted before)
:: Added:
::	scan virus and use sfc
:: Removed:
:: 	kill variable that only applied to one secrect
::	>enjoy in ascii art
::	comments
:: Improved/Changed:
:: 	improved ai a bit
::	fixed 11, 1 and 8 to new standard download system
:: Bug Fixes
:: 	touchscreen crash
:: Notes
...
:menu
mode con cols=39 lines=44
echo       __            __
echo      / /____  ___  / / ^> coded by
echo     / __/ _ \/ _ \/ / ^> chicken
echo     \__/\___/\___/_/__  ____ ___
echo       ^|_  /  ^|_  ^|^|_  ^|/ / // _ \
echo      _/_ ^<_ / __// __//_  _/ , _/
echo     /____(_)____/____(_)_//_/^|_^|
if defined name (
	echo.
	echo  hello, !name!
) else ( echo. )
